...
export class UpdateSchema1733919538853 implements MigrationInterface {
    name = 'UpdateSchema1733919538853'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "competition" ("id" SERIAL NOT NULL, "fetchId" character varying NOT NULL, "order" integer NOT NULL DEFAULT '0', "name" character varying NOT NULL, "title" character varying NOT NULL, "logo" character varying NOT NULL, "isActive" boolean NOT NULL DEFAULT false, CONSTRAINT "PK_a52a6248db574777b226e9445bc" PRIMARY KEY ("id"))`);
